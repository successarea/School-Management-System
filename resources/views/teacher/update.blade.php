        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header cardHead">
                    ...
                    <a href="/teacher/profile" style=" padding: 5px; border-radius: 5px;" class="cancel btn btn-sm float-right"><i class="fa-sharp fa-solid fa-xmark fa-2xl" style="color: #f1f0f4;"></i></a>
                </div>
                <div class="card-body">
                    <form action="/teacher/updatePf" method="POST" enctype="multipart/form-data">
                        @csrf
